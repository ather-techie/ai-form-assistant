import { SPEAKER_FIELDS, sectionHeaderStyle } from './profileFieldConfigs.js';
import SectionCustomFieldsAddon from './SectionCustomFieldsAddon.jsx';

export default function SpeakerSection({ isOpen, onToggle, values, onChange, saving, saved, onSave, onReset, customMeta = [], onAddCustomField, onDeleteCustomField }) {
  return (
    <div className="card" style={{ padding: 0, marginBottom: 8 }}>
      ...
      {isOpen && (
        <div style={{ padding: '0 12px 12px' }}>
          ...
          <SectionCustomFieldsAddon sectionId="speaker" customMeta={customMeta} values={values} onChange={onChange} onAddField={onAddCustomField} onDeleteField={onDeleteCustomField} />
